...
public class BotControllerTest {
    ...
    void updates_ShouldCallSendUpdate_ForEachUser() throws Exception {
        ...
        // Assert
        verify(botService, times(1)).sendUpdate(123L, "https://github.com/example/repo", "Обновление в репозитории");
        verify(botService, times(1)).sendUpdate(456L, "https://github.com/example/repo", "Обновление в репозитории");
    }
}
